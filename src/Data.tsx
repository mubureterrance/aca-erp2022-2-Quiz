export const data = [
    {
        question: "What is the correct way to define a React functional component with TypeScript?",
        option1: "const Component = () => { return <div>Hello</div>; }",
        option2: "function Component(): JSX.Element { return <div>Hello</div>; }",
        option3: "const Component: React.FC = () => <div>Hello</div>;",
